...
export const metadata = {
  ...
  description:
    "تقدّم Toxentra خدمات متكاملة في علم السموم والشؤون التنظيمية لدعم سلامة المنتجات، والامتثال للمتطلبات التنظيمية، والوصول إلى الأسواق العالمية.",
};
...
const services = [
  {
    n: "1",
    icon: FlaskConical,
    title: "تقييم المخاطر السُّمّية",
    href: "/services/toxicological-risk-assessment",
    text: "تقييمات شاملة للمخاطر تهدف إلى حماية صحة الإنسان ودعم الامتثال للمتطلبات التنظيمية.",
  },
  {
    n: "2",
    icon: Microscope,
    title: "التقييم البيولوجي (ISO 10993)",
    text: "خدمات التقييم البيولوجي والتوافق الحيوي وفقًا لمتطلبات معايير ISO 10993.",
  ...
  },
  {
    ...
    text: "تقييم السلامة وتقديم الدعم التنظيمي طوال دورة حياة الجهاز الطبي.",
  },
  {
    n: "4",
    icon: SprayCan,
    title: "سلامة مستحضرات التجميل (CPSR)",
    href: "/services/cosmetic-product-safety",
    text: "إجراء تقييم علمي للسلامة وإعداد التقارير بما يتوافق مع لائحة الاتحاد الأوروبي لمستحضرات التجميل (EC) رقم 1223/2009.",
  },
  {
    n: "5",
    icon: TrendingUp,
    title: "التقييم الإكلينيكي والفارماكولوجي",
    href: "/services/clinical-pharmacological-evaluation",
    text: "تقييم البيانات الإكلينيكية والفارماكولوجية والصيدلانية الحيوية لدعم تطوير المنتجات وإعداد الملفات التنظيمية وتقديمها.",
  },
  {
    n: "6",
    icon: Pill,
    ...
    bullets: ["دعم اكتشاف إشارات السلامة الدوائية", "دعم مراجعة الأدبيات العلمية", "التدريب"],
  },
  {
    n: "7",
    icon: Atom,
    title: "التصميم الجزيئي وعلم السموم الحاسوبي",
    href: "/services/molecular-design-computational-toxicology",
    text: "حلول حاسوبية تشمل CADD، وتصميم الجزيئات الصغيرة، وتخليق المستقلبات، وQSAR، والالتحام الجزيئي، وعلم السموم التنبؤي.",
  },
  {
    n: "8",
    icon: FileText,
    title: "الاستشارات العلمية والتنظيمية",
    href: "/services/scientific-regulatory-consulting",
    text: "استشارات تنظيمية استراتيجية وحلول علمية مصممة بما يتناسب مع منتجك والأسواق المستهدفة.",
  },
  {
    n: "9",
    icon: GraduationCap,
    ...
    text: "برامج تدريبية وورش عمل مصممة خصيصًا في مجالات علم السموم، واليقظة الدوائية، والعلوم التنظيمية.",
  },
];
...
const process = [
  {
    ...
    text: "نتعرّف على منتجك وأهدافك واحتياجاتك التنظيمية.",
  },
  {
    n: "02",
    icon: Microscope,
    title: "التقييم العلمي",
    text: "يجري خبراؤنا التقييمات والدراسات اللازمة وفقًا لاحتياجات مشروعك.",
  },
  {
    n: "03",
    icon: ShieldCheck,
    title: "الاستراتيجية التنظيمية",
    text: "نطوّر استراتيجية واضحة لتلبية المتطلبات التنظيمية ذات الصلة.",
  },
  {
    n: "04",
    icon: FileText,
    title: "التقرير النهائي والدعم المستمر",
    text: "نقدّم تقارير شاملة ونواصل دعمك خلال المراحل اللاحقة.",
  },
];
