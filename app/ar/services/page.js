...
const services = [
  ...
  },
  {
    n: "8",
    icon: FileText,
    title: "الاستشارات العلمية والسُّمّية",
    href: "/services/scientific-regulatory-consulting",
    text: "حلول علمية مصممة وفقًا لمنتجك والأسواق المستهدفة، ومتوافقة مع المتطلبات التنظيمية.",
  },
  {
    n: "9",
    icon: GraduationCap,
...
const process = [
  ...
  },
  {
    n: "03",
    icon: ShieldCheck,
    title: "استراتيجية متوافقة مع المتطلبات التنظيمية",
    text: "نقدّم حلولًا علمية متوافقة مع المتطلبات التنظيمية المعمول بها.",
  },
  {
    n: "04",
    icon: FileText,
