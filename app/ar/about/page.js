...
const stats = [
  ...
  },
  {
    icon: FlaskConical,
    big: "مئات",
    label: "التقييمات العلمية للسلامة",
    text: "في مجالات الأدوية والأجهزة الطبية ومستحضرات التجميل والمواد الكيميائية.",
  },
  {
    icon: ShieldCheck,
    big: "معتمد من ERT",
    label: "اختصاصي سموم أوروبي مسجّل",
    text: "اعتماد مهني معترف به في أوروبا.",
  },
  {
    icon: Globe2,
...
const whatWeDo = [
  [
    "تقييم المخاطر السُّمّية",
    "التقييم البيولوجي (ISO 10993)",
    "سلامة مستحضرات التجميل (CPSR)",
    "علم السموم الدوائي",
  ],
  [
...
const research = [
  {
    icon: Microscope,
    title: "تقييم مبتكر للمخاطر",
    text: "تطوير أساليب ومنهجيات متقدمة في التقييم السُّمّي.",
  },
  {
    icon: Settings,
    title: "سلامة الأجهزة الطبية",
    text: "استراتيجيات التقييم البيولوجي والتوافق الحيوي.",
  },
  {
    icon: TestTube,
    title: "سلامة التركيبات والمنتجات",
    text: "تقييم سلامة التركيبات الدوائية والتجميلية المبتكرة.",
  },
  {
    icon: Share2,
    title: "البحث التعاوني",
    text: "تعاونات أكاديمية وصناعية تهدف إلى تعزيز التقدم العلمي.",
  },
];
            ...
            {stats.map((s) => {
              ...
              return (
                <div key={s.big} className="bg-white rounded-2xl p-5 sm:p-6 md:p-7 shadow-xl sm:aspect-square flex flex-col justify-center">
                  ...
                  {s.label && (
                    <div className="text-sm font-bold text-navy-deep leading-snug">{s.label}</div>
                  )}
                </div>
              );
            })}
