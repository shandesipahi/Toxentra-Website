...
const contactInfo = [
  { icon: Mail, title: "البريد الإلكتروني", lines: ["info@toxentra.com"] },
  { icon: MapPin, title: "الموقع", lines: ["إسطنبول، تركيا"] },
  { icon: Clock, title: "ساعات العمل", lines: ["Monday – Friday", "09:00 – 17:30 (GMT+3)"] },
];
